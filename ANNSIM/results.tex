...
\begin{figure}[ht]
    ...
    \caption{The percentage of rational election outcomes remains constant over
time when there are no chasers (left). When there is one chaser (middle) or
three chasers (right), the rationality of elections decreases over time. The
more chasers there are, the more the rationality decreases.}
